...
const api: NegLiftApi = {
  ...
  listFidelityConfigurations: () => ipcRenderer.invoke(CHANNEL.fidelityList),
  saveFidelityConfigurationDraft: (configuration) => ipcRenderer.invoke(CHANNEL.fidelitySaveDraft, configuration),
  activateFidelityConfiguration: (id) => ipcRenderer.invoke(CHANNEL.fidelityActivate, id),
  reviseFidelityConfiguration: (id, nextId, createdAt, changes) =>
    ipcRenderer.invoke(CHANNEL.fidelityRevise, id, nextId, createdAt, changes),
  importFidelityConfigurations: () => ipcRenderer.invoke(CHANNEL.fidelityImport),
  exportFidelityConfigurations: () => ipcRenderer.invoke(CHANNEL.fidelityExport),
